...
export function mountRiskV4(root){
  ...
  bind('riskV4Summary', e=>{ d.summary=e.target.value; });
  bind('riskV4Mitigation', e=>{ d.mitigation=e.target.value; });
  bind('riskV4SignMed', e=>{ d.sign.med=e.target.value; });
  bind('riskV4SignNurse', e=>{ d.sign.nurse=e.target.value; });
  bind('riskV4DateMed', e=>{ d.sign.medDate=e.target.value; });
  bind('riskV4DateNurse', e=>{ d.sign.nurseDate=e.target.value; });
